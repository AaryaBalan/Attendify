    ...
    return (
        <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-lg border-b border-orange-100 shadow-sm">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center gap-4">
                <Link to={isLoggedIn ? "/dashboard" : "/signin"} className="flex items-center gap-2 text-xl font-bold text-orange-600 hover:text-orange-700 transition">
                ...
                <nav className="hidden lg:flex ml-auto items-center gap-2">
                    {isLoggedIn ? (
                        <>
                            <Link to="/dashboard" className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-700 transition">
            ...
            {mobileMenuOpen && (
                <div className="lg:hidden border-t border-orange-100 bg-white">
                    <nav className="flex flex-col p-4 space-y-2">
                        {isLoggedIn ? (
                            <>
                                <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-700 transition">
