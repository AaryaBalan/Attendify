            ...
            <div className="w-full max-w-lg">
                <div className="bg-white border border-orange-100 rounded-2xl shadow-xl p-8">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-gray-500 mt-2">Sign in to continue to Attendify</p>
                    </div>
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <button type="submit" className="w-full bg-linear-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white rounded-xl px-4 py-3.5 font-semibold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5">Sign In</button>
                    </form>
                    <div className="mt-6 text-center">
                        <Link to="/signup" className="text-sm text-gray-600 hover:text-orange-600 font-medium">
                            Don't have an account? <span className="text-orange-700 font-semibold">Sign up</span>
                        </Link>
                    </div>
                </div>
            </div>
